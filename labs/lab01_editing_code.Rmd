...
make your edits that way. Otherwise, you can work with it directly in this RMarkdown file
...
you write the code. These calls are very helpful as you're writing the code,
...
out the dataframe (`man_animal_resp`) or elements of it (`colnames(man_animal_resp)`). It can include other pieces of code you used in an exploratory way (e.g., calls to `summary` or `range`).
...
the new line align with other parts of the nested function call. 
...
This step is not as critical as the previous ones, but it can help clarify and improve the
readability of your code, in particular by reinforcing how the code is divided into blocks that
...
This is alright, but in many cases, we could chain several of the steps together
