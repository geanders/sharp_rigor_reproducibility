...
being binary). The paper uses health data that is sensitive and cannot be publicly posted, 
and this prevents them from making the paper fully computationally reproducible. 
...
that includes some of the same authors: 
