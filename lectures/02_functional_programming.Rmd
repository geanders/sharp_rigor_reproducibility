...
We can edit the function to use better names. Originally, the input and output
...
Also, you can guarantee with package the code gets the function from. If you're
